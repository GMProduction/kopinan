    ...
    <div class="wrapper d-flex align-items-stretch " style="height: calc(100vh)">
        <div class="d-flex flex-column" style="max-height: 100vh; ">
            <div class="image-sidebar ">
                <div class="d-flex  flex-column  " id="image-sidebar"
                    style="justify-content: center; align-items: center; height: 70px">
        ...
        <div id="content" class="relative " style=" ">
            <div class="w-full  navbar-custom justify-content-between pe-3"
                style="height: 70px;background-color: #F4F7FE">
                <div class="w-full  navbar-custom gap-2" style="height: 70px">
                    <a role="button" id="sidebarCollapse" class="m-0 d-flex text-primary"
                        style="color: white; justify-content: center; align-items: center; text-decoration: none">
                        <i class="material-icons">menu</i>
                    </a>
                </div>
            ...
            if (lok1 === undefined || lok1 === '') {
                ...
                if (url.includes('edit')) {
                    ...
                    if (lok2) {
                        ...
                        if (split2 == 'laporan capaian standart pelayanan' || split2 ==
                            'rekap capaian standart pelayanan') {
                        ...
                        if (lok1 === 'format-mutu-dan-sdm' || lok1 === 'laporan-triwulan' || lok1 === 'manajemen-user' ||
                            lok1 === 'rekap-triwulan') {
                            if (lok3) {
                                title =
                                    '<a class="me-1" role="button" onclick="window.history.back()"><i class="material-icons align-middle">arrow_back</i></a>' +
                                    title
                            }
                        } else {
                            title =
